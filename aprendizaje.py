...
class Aprendizaje(AsistenteVoz):
    ...
    def mostrar_ventana_aprendizaje(self):
        ...
        Button_back_to_options = ctk.CTkButton(master=main_frame, text='Volver a Opciones', height=40, width=250,
                                               ...
                                               command=lambda: self.cerrar_ventana_aprendizaje(window))
...
=======
        ...
        self.static_image_label = None
>>>>>>> 2b8756e43dab1dc2d7c085798921e31708e3af19
...
<<<<<<< HEAD
        self.texto_a_audio(
            "Bienvenido a la interfaz de Aprendizaje, se mostraran el abecedario en señas, con presionar next puedes moverte a la siguiente letra")
